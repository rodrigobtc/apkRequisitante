var myApp = angular.module('starter.controllers', ['ionic', 'ngCordova'])
...
.controller('LaudoCtrl', function($scope, exameFactory) {

})

.factory('pacienteFactory', function(){
  var pacientePriv = {};
